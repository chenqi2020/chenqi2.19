...
public class User  implements Serializable{
	...
	public int hashCode() {
		...
		result = prime * result + ((isRemember == null) ? 0 : isRemember.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (id == null) {
			...
			return false;
		if (isRemember == null) {
			if (other.isRemember != null)
				return false;
		} else if (!isRemember.equals(other.isRemember))
			return false;
		if (locked == null) {

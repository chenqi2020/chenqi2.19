		...
		<div class="row" style="height: 80px; margin-top: 8px">
			<div class="col-md-12" style="background-color: #ccc">
				<img alt="" src="/resource/images/logo.png" height="80px"
					...
					<font color="#ffffff">个人中心 登录人:${sessionScope.user.username }
		...
		<div class="row" style="height: 550px">
			...
			<div class="col-md-3" style="background-color: #ccc">
				<div class="list-group" style="margin-top: 20px">
					<a href="#" data="/my/article/articles" class="list-group-item list-group-item-action active">
						我的文章 </a> <a href="#" data="/my/article/publish"
						class="list-group-item list-group-item-action">发布文章</a> 
						<a href="#" class="list-group-item list-group-item-action"  data="/my/article/collop">我的收藏</a> 
						<a href="#" class="list-group-item list-group-item-action"  data="/my/article/comments">我的评论</a>
						<a href="#" class="list-group-item list-group-item-action">用户设置</a> <a
